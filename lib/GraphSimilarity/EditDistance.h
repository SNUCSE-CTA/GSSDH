...
class GraphEditDistanceSolver
{
  ...
  public:
    ...
    ui size_based_bound()
    {
        ...
        ui r1 = G1->GetNumVertices() > G2->GetNumVertices() ? G1->GetNumVertices() - G2->GetNumVertices() :
    ...
    ui ged_lower_bound_filter()
    {
        ...
        lb = (G1->GetNumVertices() > G2->GetNumVertices() ? G1->GetNumVertices() : G2->GetNumVertices());
    ...
    void ComputeBranchDistanceMatrix(State *state, std::vector<std::vector<int>> &branch_distance_matrix,
